      ...
      <div className="sm:ml-64 ml-24 mx-10 overflow-x-auto w-[72rem] my-10 sm:my-0 h-screen flex flex-col">
        ...
        <div className="flex flex-col gap-4 justify-center items-center">
          <div className=" w-full flex sm:flex-row flex-col gap-10 justify-around">
            ...
            <Link
              to={"/mytickets/usercreate"}
              className="border-2 flex font-semibold hover:bg-black hover:text-white duration-150 transition-all border-black p-2 rounded-md text-black cursor-pointer text-center flex items-center w-44 gap-2 justify-center"
              onClick={() => setShowCountry(!showCountry)}
            >
              <PiPlusCircle size={29} />
              AddNew
            </Link>
